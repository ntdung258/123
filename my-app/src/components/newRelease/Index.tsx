...
const NewRelease: React.FC = () => {
  ...
  const displayedNewRelease = newRelease.slice(0, 8);
  ...
  return (
    <div className="new-release-movie mt-5">
      <div>
          <div className="row">
              <div className="col-6">
                  <span className="text-white title-h3">NewRelease</span>&ensp;&ensp;&ensp;
      ...
      <div className="row mt-3">
        {displayedNewRelease.map((newRelease) => (
            <div className="col-md-3">
                <div className="">
                    <img style={{ width:'100%', height: '344px' }} src={`https://image.tmdb.org/t/p/w220_and_h330_face${newRelease.backdrop_path}`} alt='' />
                </div>
                <div className="float-start m-2 pt-1 nrm-name">
                    <span className="text-white">Ghosted</span>
                </div>
                <div className="float-end m-2">
                    <button style={{marginRight:'7px'}} className="mr-5 btn-hd"><span>HD</span></button>
